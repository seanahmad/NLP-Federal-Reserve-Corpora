...
fig.suptitle('Correlation of text_df to next_decision', fontsize=24)
fig.tight_layout(pad=3.0)
plt.show()
plt.savefig(graph_dir + 'corr_per_doc_type.png', )#bbox_inches='tight')
  ...
  for epoch in range(epochs):
    ...
    for text_batch, meta_batch, labels in dataloader(X_train_text, X_train_meta, y_train, batch_size=batch_size, sequence_length=sequence_length, shuffle=False):
      ...
      if steps % print_every == 0:
        ...
        plt.show()
        plt.savefig(graph_dir + , 'confusion_matrix_full.png')#bbox_inches='tight')
...
def train_bert(fold, train_indices, valid_indices):
    ...
    plt.ylabel("Loss")
    plt.show()
    plt.savefig(graph_dir + 'training_validation_loss_latest.png', )#bbox_inches='tight')
    ...
    plt.show()
    plt.savefig(graph_dir + 'bert_trained.png')#bbox_inches='tight')
